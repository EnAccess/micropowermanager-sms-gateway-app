...
Issues are created [here](https://github.com/EnAccess/micropowermanager-sms-gateway-app/issues/new/choose)

### How to Contribute to Issues

For any issue, there are fundamentally three ways an individual can contribute:

- **By opening the issue for discussion:** If you believe that you have found a new bug in this project, you should report it by creating a new issue in the [issue tracker](https://github.com/EnAccess/micropowermanager-sms-gateway-app/issues).
